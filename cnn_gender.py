...
# load data from UTK, 3:1 as train/test ratio 
img, lbl = load_data_from_folder(saved=True)
lbl = lbl[:, 2:3] # the column of gender
(train_images, train_labels), (test_images, test_labels) = \
sample_images(img, lbl, ratio=3)
...
plt.savefig("sample_gender_training_set.png")
plt.clf()
...
plt.savefig("sample_gender_test_set.png")
plt.clf()
